...
\caption{Temporal changes in wind risk over time}
\end{figure}
...
\paragraph{Limitation of the study}\label{limitation-of-the-study}

Our study design have multiple limitation, inhereted from application of
teh pixel (30x30m) resolution to stand level (mean: 1.5 ha). This likely
overestimated the volume under risk due to larger computational unit.
However, Finnish forests stands are relatively homogenous in terms of
species composition, tree height and age composition. Further, scarce
windthrown damage or tree breakage due to wind or snow occurs annualy,
while rare extreme winds could decimate all mature trees available on
stands. As such, the expectation of the rate of wind damage vary.
...
recalculate teh datasets from the highest stratum, and supposed that
this stratum will be the most affected if damaged?? Proportion between
the V of tallest stratum and and total volume of the stand could shed
light on the how much timber volume is at risk at certain time.
