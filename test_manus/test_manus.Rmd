...
```{r fig_4_plot_V_timber, fig.width = 7, fig.height = 6, fig.cap = "A. Mean standing and B. harvested pulp and log timber under three types of management regimes over harvest intensity gradient"}
...
```{r fig_windRisk_time_change, fig.width = 7, fig.height = 6, fig.cap = "Temporal changes in wind risk over time"}
