...
```
```{r hist-Suvanto-values, eval = T, echo = F, warning = F, message = F, include = T}
...
Figure S1 Mean total stand  timber volume (m3/ha)  for landscapes under RF, CCF and ALL  scenarios over harvest intensity gradient (NPI, net present income, left column) and over time (right column) for actively managed stands and set asides.  
