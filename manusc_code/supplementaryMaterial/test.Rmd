...
names(suvanto_df) <- c("windRisk", "Source")
...
```{r  plot-SA-chars, eval = T, echo = F, warning = F, message = F, include = T, fig.width = 7, fig.height = 2.7, fig.cap = "\\label{fig:plot-SA-chars} FINISH THIS ONE !!!"}
